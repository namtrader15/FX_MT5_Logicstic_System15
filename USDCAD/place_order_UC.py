...
from atr_check_UC import atr_stop_loss_finder  # Hàm tính ATR từ MetaTrader 5 (MT5)
import random
...
def get_realtime_price_mt5(symbol="USDCAD"):
...
def place_order_mt5(client=None, order_type="buy", symbol="USDCAD", risk_amount=97, risk_reward_ratio=1.7):
    """
    ...
    Parameters:
        ...
        symbol (str): Ký hiệu giao dịch (mặc định "USDCAD").
    ...
    order = {
        ...
        "deviation": 20,  # Độ trượt giá cho phép
    ...
    if result is None:
        ...
        last_order_status = f"Đã {order_type} {volume} lots USDCAD ở giá {mark_price:.2f} với Stop Loss: {stop_loss_price:.2f} và Take Profit: {take_profit_price:.2f}."
...
if __name__ == "__main__":
    ...
    if connect_mt5():
        ...
        place_order_mt5(None, "buy", "USDCAD", risk_amount=97)  # Thay symbol thành "USDCAD"
        mt5.shutdown()
    else:
