...
def atr_stop_loss_finder(symbol, length=14, multiplier=1.5, smoothing="RMA"): 
    # Lấy dữ liệu nến từ MetaTrader 5 (MT5) cho EURCAD, khung thời gian 1 giờ
    timeframes = {
    ...
    atr_short_stop_loss = round(highs[-1] + atr_value, 5)  # ATR cho Short Stop Loss
    atr_long_stop_loss = round(lows[-1] - atr_value, 5)    # ATR cho Long Stop Loss
...
def main():
    ...
    symbol = "EURCAD"  # Thay thế thành cặp giao dịch EURCAD
